...
async def change_activity():
    ...
    if random_status:
        ...
        if activity=="s":
            activity=discord.Streaming(name=f'from {random.choice(activity_s)}', url="https://www.youtube.com/channel/UCKZJEX2VifHDOpuN1KU16Gw")
        elif activity=="p":
...
async def stream(ctx, *, text:str=None):
    if not text == None:
        ...
        with open('config.json', 'w') as e:
            ...
            json.dump(f, e)
        await Blank.change_presence(activity=discord.Streaming(name=text, url="https://www.youtube.com/channel/UCKZJEX2VifHDOpuN1KU16Gw"))
